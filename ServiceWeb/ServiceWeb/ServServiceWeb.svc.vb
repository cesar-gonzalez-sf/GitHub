...
Public Class ServValidateOrder
    ...
    Public Function ValidateOrder(
        ...
        ByVal siteURL As String) As Respuesta Implements IServiceWeb.ValidateOrder
    ...
    Public Function OptionsValidateOrder() As InfMetodo Implements IServiceWeb.OptionsValidateOrder
        'Se agrega headers por CORS
        AgregaHeaderPorCORS()
