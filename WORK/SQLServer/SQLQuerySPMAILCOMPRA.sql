...
-------------------------------------------------------------------------      
-- Modificado por : César González-Rubio   
-- Fecha		  : 11-06-2019      
                            ...
                            <table role="test" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td><img src="http://soa-iis.imperial.cl/pictures/logo.jpg" alt="ImperialImage">
                                        ...
                                        <br>
                                        <p class="Seguimieinto-parrafo">Para hacer un seguimiento a tu compra, solo debes hacer clic en el "<a href="https://www.imperial.cl/tracking" target="Blank_"><font color = "blue"><u>Seguimiento de Pedidos</u></font></a>" digita el número de documento (Boleta o Factura).</p>
