 DECLARE @NRO_DOCUMENTO_PADRE INT  = '19563073'
                            ...
                            <table role="test" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td><img src="http://soa-iis.imperial.cl/pictures/logo.jpg" alt="ImperialImage">
                                        ...
                                        <p class="Informacion-title">Te informamos que tu pedido se encuentra en proceso de validación.</p>
                                        <br><b>Pasos a Seguir:</b>
                                        <ol type="1">
                                            <li> Validaremos tu pedido.</li>
                                            <li> Recibir un correo electrónico con tu boleta o factura y el detalle de la compra.</li>
                                            <li> Confirmar por correo cuando esté comprando esta lista para la '+ @FLETE +'.</li>
                                        </ol>
                                        <br>
                                        <p class="Seguimieinto-parrafo">Para hacer un seguimiento a tu compra, solo debes hacer clic en el "<a href="https://www.imperial.cl/tracking" target="Blank_"><font color = "blue"><u>Seguimiento de Pedidos</u></font
></a>" digita el número de documento (Boleta o Factura).</p>
                                   ...
                                   <font color="blue"><u>Términos y condiciones</u></font></a>". De cualquier inconveniente o retraso en la validación de los datos o la emisión de la boleta, a través de un correo electrónico.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <a style="text-decoration: none;" href="https://play.google.com/store/apps/details?id=cl.imperial.app&hl=es">
                                    <img style="vertical-align:middle" src="https://ci3.googleusercontent.com/proxy/A4cGq2mesKkJ1HQ1eOL54jbMzpKFUphXcRZQdENwdkN8wardKne12RcJmHPf5xpm6fYGhvbB5K-Z_V8UlhN2XR8DvRGM0e4m1rQSw1TcBC0HXiPaGQs_uP_8yAhCupU5wkH0HlCNQJO
x1-BSsw=s0-d-e1-ft#http://main.cdn.wish.com/latest/img/mobile_download_page/banner_google_equal.png?v=62cb513" target="Blank_" width="100" height="30">
                                </a>
                                <a style="text-decoration: none;" href="https://apps.apple.com/cl/app/imperial-app/id1131355568">
                                    <img style="vertical-align:middle" src="https://ci4.googleusercontent.com/proxy/zWXDNvTkM_A4CG4us1M_9XGytK0-sLs_b2fKZ9SUXjrsrWhYhR0OSmFEUJgWJva2-fJXlN0SX_bX-gdZNQCQKjc8Ovb3AHXtcufH2mho62DUH-0a7NBhnohX87jJ3iAtKfLmvUU7bRD
6bsut=s0-d-e1-ft#http://main.cdn.wish.com/latest/img/mobile_download_page/banner_apple_equal.png?v=61ed113" target="Blank_" width="100" height="30">
                                </a>
                                <br>
                                <br>
                                <table role="presentation" class="footer-content" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="phone-contact"> CALL CENTER <img height="20" src="https://soa-desa-iis.imperial.cl/optimizador-app/assets/images/phone.png" alt="phoneImage" /> <span class="phone">(562) 2399 700</span>&nbsp;&nbsp;&nbsp;|
&nbsp;&nbsp;&nbsp; MAIL <img height="30" src="https://soa-desa-iis.imperial.cl/RsAppImperial/images/gmail.png  "><b class="MAIL">contacto@imperial.cl</b> </td>
