...
Begin      
 ...
 border-left-width: 0 !important;
  ...
  /* -------------------------------------    PRESERVE THESE STYLES IN THE HEAD    ------------------------------------- */
    ...
    <body>
        <center>
            <IMG src="'+@RutaImg+'header.jpg" width="80%" HEIGHT=150>
        </center>
        <br>
        ...
        <br>
        <div>
            A partir del dia ' + @FechaEntrega + ' segun la fecha comprometida, entre las 08:30-18:30 hrs.
        </div>
        <br>
        <CENTER>
            ...
            <br>
                            ...
                            <center>
                                <IMG  src="'+@RutaImg+'footer.jpg" width= 80% HEIGHT=320>
								<td align="center">
									...
									<a style="text-decoration: none;" href="https://play.google.com/store/apps/details?id=cl.imperial.app&hl=es">
										<img style="vertical-align:middle;  margin-top: -15px" src="'+@RutaImg+'footer_app2.jpg" target="Blank_" width="100" height="30">
									</a>
									<a style="text-decoration: none;" href="https://apps.apple.com/cl/app/imperial-app/id1131355568">
										<img style="vertical-align:middle; margin-top: -15px" src="'+@RutaImg+'footer_app.jpg" target="Blank_" width="100" height="30">
									</a>
								</td>
                            </center>
							<br>
     ...
     Set @HtmlCollect = '<html>      
		...
		<IMG src="'+@RutaImg+'header.jpg" width="80%" HEIGHT=150>      
         ...
         <br>
         <div>A partir del dia ' + @FechaEntrega + ' segun la fecha comprometida, de Lu-Vi 08:30-18:30 hrs Sábados 09:00-14:00 hrs.</div>
         <br>
