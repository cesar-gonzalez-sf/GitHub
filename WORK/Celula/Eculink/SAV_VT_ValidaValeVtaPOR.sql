ALTER PROCEDURE [dbo].[SAV_VT_ValidaValeVtaPOR]
--------------------------------------------------------------------------------
--------------------------------------------
-- Author:			<Cesar Gonzalez SF> '0014282088','BLV','21358000336'-----'0011198067','FCV','21358000336'
-- Modified Date:	<15/05/2020>
-- Description:		<Se valida pago POR>
--------------------------------------------
	@NRO_IMPRESO AS VARCHAR(10),   
	@TIPO_DOCUMENTO AS VARCHAR(3),
	@CODIGO_POR AS VARCHAR(20) 
AS
BEGIN
	SET NOCOUNT ON
	Set Xact_Abort On
	...
	BEGIN
		...
		INSERT INTO #RESULT_TWO
			SELECT 
				...
				CAST(Ltrim(Rtrim('1'))			AS NVARCHAR) AS TIPO_MONEDA,
